...
export const useEvents = () => {
  ...
  const createEvent = useApiMutation<{ success: boolean; data: Event }, CreateEventDto>({
    url: "/events",
    method: "POST",
  });
  ...
  const registerForEvent = (eventId: string) =>
    useApiMutation<{ success: boolean; data: EventRegistration }, { notes?: string }>({
  ...
  const getEventAttendees = (eventId: string) =>
    useApiQuery<{ success: boolean; data: any[] }>(["event-attendees", eventId], {
